...
mixin _$UserEvent {
  ...
  TResult maybeWhen<TResult extends Object?>({
    TResult Function(String email, String password)? loginEvent,
    TResult Function(String email, String password, String name)? registerEvent,
    TResult Function()? logoutEvent,
...
class _$LoginEventImpl implements _LoginEvent {
  ...
  @override
  String toString() {
    return 'UserEvent.loginEvent(email: $email, password: $password)';
  }
...
class _$RegisterEventImpl implements _RegisterEvent {
  ...
  @override
  String toString() {
    return 'UserEvent.registerEvent(email: $email, password: $password, name: $name)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return registerEvent(email, password, name);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return registerEvent?.call(email, password, name);
  }
